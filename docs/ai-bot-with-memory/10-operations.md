...
в публичные возможности без соответствующего инструмента. В ответах о возможностях список доменов не передаётся модели;
бот выводит действия из tool definitions и редакционной статьи RAG.
