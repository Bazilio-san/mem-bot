...
критерий поджатия истории диалога (18) и три критерия глобальной памяти (19–21). Каждый критерий ДОЛЖЕН опираться на
конкретный опорный модуль и подтверждаться проверкой.
