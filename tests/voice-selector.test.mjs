...
check('1. Каталог содержит ожидаемые голоса', ['alloy', 'ash', 'nova', 'onyx', 'verse']
  .every((voice) => VOICE_IDS.includes(voice)));
...
check('5. Defaults по полу зафиксированы',
  DEFAULT_VOICE_BY_GENDER.m === 'ash'
  && DEFAULT_VOICE_BY_GENDER.f === 'nova'
  && DEFAULT_VOICE_BY_GENDER.mf === 'alloy');
