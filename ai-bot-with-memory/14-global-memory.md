...
С этими двумя таблицами общее число таблиц схемы — девятнадцать (вместе с реестром схем доменов
`mem.domain_schemas`, см. [05-data-schema.md](05-data-schema.md)). Колонка
