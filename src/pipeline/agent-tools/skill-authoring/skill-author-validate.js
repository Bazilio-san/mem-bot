...
export const skillAuthorValidateTool = {
  ...
  definition: {
    ...
    function: {
      name: 'skill_author_validate',
      description: `Validate a skill without writing it: checks frontmatter shape, required blocks, that allowed
tools exist, and domain_key uniqueness. Validates the draft prepared in this conversation if any,
otherwise the on-disk skill. Returns ok and a list of issues.`,
      parameters: {
        type: 'object',
