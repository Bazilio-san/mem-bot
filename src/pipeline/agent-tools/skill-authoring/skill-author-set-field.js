...
function setField(skill, field, value) {
  switch (field) {
    case 'title':
      skill.title = String(value);
      break;
    case 'description':
      skill.description = String(value);
      break;
    case 'enabled':
    ...
    case 'positive_signals':
      skill.classification.positive_signals = toArray(value);
      break;
    case 'negative_signals':
      skill.classification.negative_signals = toArray(value);
      break;
    case 'tools_allowed':
      skill.tools.allowed = toArray(value);
      break;
    case 'tools_base':
      skill.tools.base = value === true || value === 'true';
      break;
    case 'model_main':
      skill.model.main = value || null;
      break;
    case 'model_extract':
      skill.model.extract = value || null;
      break;
    case 'references_allowed':
