...
export const skillAuthorRemoveReferenceTool = {
  ...
  definition: {
    ...
    function: {
      name: 'skill_author_remove_reference',
      description: `Delete a reference file from a skill references folder. Requires confirm=true. 
The path must be relative inside references/** (no absolute paths or "..").`,
      parameters: {
        type: 'object',
